...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\mesia\Desktop\PROYECTO tesis\Modelos V3\Proyecto django\libreria'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\mesia\Desktop\PROYECTO tesis\Modelos V3\Proyecto django\libreria\Scripts\deactivate.nu'
